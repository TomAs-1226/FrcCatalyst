...
<p style="margin-top: -8px">
  ...
  <img src="https://img.shields.io/badge/LimelightLib-2.0.0--beta2-22c55e?style=flat-square" alt="LimelightLib 2.0.0-beta2"/>
</p>

## What this site documents

**Catalyst 2.0.0-alpha.2**: tag `v2.0.0-alpha.2`, WPILib 2027.0.0-alpha-6, Systemcore OS image 13.
The newer code for the same platform is **2.0.0-alpha.5** (branch `systemcore-alpha6`: Autonomy
...
[spec sheet](advanced/robot-identity.html) under `/Catalyst/Robot/` — team number, season, controller and
